    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='authapp.Supplier')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('updated_on', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('material', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lechnerapp.Material')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='lechnerapp.Product')),
                ('supplier', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='authapp.Supplier')),
            ],
        ),
        migrations.CreateModel(
